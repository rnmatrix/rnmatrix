...
export interface IToast<C extends any> {
    key: string;
...
export default class ToastStore extends EventEmitter {
    ...
    static sharedInstance() {
        if (!global.mxToastStore) global.mxToastStore = new ToastStore();
        return global.mxToastStore;
    }
     ...
     */
    addOrReplaceToast<C extends any>(newToast: IToast<C>) {
